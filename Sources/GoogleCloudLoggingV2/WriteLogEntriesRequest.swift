  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let partialSuccess = CodingKeys(stringValue: "partialSuccess")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .partialSuccess) {
      self.partialSuccess = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.partialSuccess, forKey: .partialSuccess)
