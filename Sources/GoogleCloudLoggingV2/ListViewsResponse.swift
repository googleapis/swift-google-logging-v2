...
public struct ListViewsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// A list of views.
  public var views: [LogView] = []
  ...
  /// Initialize a new instance of `ListViewsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListViewsResponse().with { $0.views = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([LogView].self, forKey: .views) {
      self.views = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.logging.v2.ListViewsResponse"
  }
