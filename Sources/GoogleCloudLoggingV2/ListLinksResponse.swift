...
public struct ListLinksResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// A list of links.
  ...
  /// Initialize a new instance of `ListLinksResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLinksResponse().with { $0.links = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Link].self, forKey: .links) {
      self.links = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.logging.v2.ListLinksResponse"
  }
...
extension ListLinksResponse: GoogleGax._PaginatedResponse {
