...
public struct LogSink: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum VersionFormat: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:VersionFormat/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:VersionFormat/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("VERSION_FORMAT_UNSPECIFIED")
