  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([LogBucket].self, forKey: .buckets) {
      self.buckets = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.logging.v2.ListBucketsResponse"
  }
